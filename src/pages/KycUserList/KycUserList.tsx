...
const tableHeaders = ["ID", "EMAIL", "WALLET ADDRESS", "COUNTRY", "KYC STATUS", "ACTION"];
            ...
            <Table className={classes.table}>
              ...
              <TableBody className={classes.tableBody}>
              {
                admins && admins.length > 0 && admins.map((admin: any, index: number) =>  (
                    <KycUserRow key={admin.id} currentOpen={currentOpen} setCurrentOpen={handleCurrentOpenSet} admin={admin} countries={countriesMapping} getAdminListInfo={getAdminListInfo} />
                  ))
              }
              </TableBody>
            </Table>
