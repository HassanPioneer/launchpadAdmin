...
import PoolsRecord from './PoolsRecord'
            ...
            <Table component='div' className={classes.table}>
                ...
                <TableRow component='div'>
                  {
                    tableHeaders.map((tableHeader: string, index: number) => (
                      <TableCell component='div' key={index} className={classes.tableHeader}>{tableHeader}</TableCell>
                    ))
                  }
                </TableRow>
              </TableHead>
              <TableBody component='div' className={classes.tableBody}>
              {
                  campaigns && campaigns.length > 0 && campaigns.map((campaign: any, index: number) =>  (
                    <PoolsRecord key={campaign.id} currentOpen={currentOpen} setCurrentOpen={handleCurrentOpenSet} campaign={campaign} />
                  ))
              }
              </TableBody>
            </Table>
